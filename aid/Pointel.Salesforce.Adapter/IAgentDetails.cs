...
namespace Pointel.Salesforce.Adapter
{
    ...
    public interface IAgentDetails
    {
        ...
        /// <summary>
        /// Property used to send request to Subscriber (AID/WDE/iWS/any 3rd party applications) requesting about agent current status
        /// </summary>
        CurrentAgentStatus AgentVoiceMediaStatus { get; }

        /// <summary>
        /// Property used to receive TServer Protocol from Subscriber
        /// </summary>
        TServerProtocol TServer { get; }

        /// <summary>
        /// Property used to receive UCS Protocol from Subscriber
        /// </summary>
        UniversalContactServerProtocol UCSServer { get; }
